        ...
        <vaadin-form-layout id="form4" colspan="2">
          <template is="dom-if" if="[[item.customer.details]]">
            <vaadin-form-item label-position="top">
              <label slot="label">Подробности</label>
              <span>[[item.customer.details]]</span>
            </vaadin-form-item>
          </template>

          <vaadin-form-item>
            <label slot="label">Заказ</label>
          ...
          <vaadin-form-item id="comment" hidden="[[review]]">
            <vaadin-text-field id="commentField" placeholder="Добавить коментарий" class="full-width" on-keydown="_onCommentKeydown" 
              maxlength="255">
              <div slot="suffix" class="comment-suffix">
                <vaadin-button id="sendComment" theme="tertiary">Отправить</vaadin-button>
              </div>
            </vaadin-text-field>
          </vaadin-form-item>
