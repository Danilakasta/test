 ...
 * data.
 */
public class ProductAmountViewLogic implements Serializable {

    private final ProductAmountView view;

    public ProductAmountViewLogic(ProductAmountView simpleCrudView) {
        view = simpleCrudView;
    }
    ...
    private void setFragmentParameter(String productId) {
        ...
        UI.getCurrent().navigate(ProductAmountView.class, fragmentParameter);
    }
        ...
        if (productId != null && !productId.isEmpty()) {
            if (productId.equals("new")) {
                ...
                try {
                    ...
                    final ProductAmount product = findProduct(pid);
    ...
    private ProductAmount findProduct(int productId) {
        return null;// DataService.get().getProductById(productId);
    }

    public void saveProduct(ProductAmount product) {
    ...
    public void deleteProduct(ProductAmount product) {
        view.clearSelection();
    ...
    public void newProduct() {
        ...
        view.editProduct(ProductAmount.builder().build());
    }

    public void rowSelected(ProductAmount product) {
       // if (AccessControlFactory.getInstance().createAccessControl()
        //        .isUserInRole(AccessControl.ADMIN_ROLE_NAME)) {
            editProduct(product);
     //   }
