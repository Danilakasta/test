...
public class ConcurrentProductForm extends Div {

    private final VerticalLayout content;

    SiteProductService productService;
 ...
 //   private final CheckboxGroup<Category> category;
    ...
    private ConcurrentProductViewLogic viewLogic;

    public void setViewLogic(ConcurrentProductViewLogic viewLogic) {
        this.viewLogic = viewLogic;
    }

    private final Binder<SiteProduct> binder;
    private SiteProduct currentProduct;
    ...
    @Autowired
    public ConcurrentProductForm(ConcurrentProductViewLogic viewLogic, SiteProductService productService) {
...
*/
        binder = new BeanValidationBinder<>(SiteProduct.class);
...
**/
  ...
  //  }
    ...
    public void editProduct(SiteProduct product) {
        if (product == null) {
            product = SiteProduct.builder().build();
        }
